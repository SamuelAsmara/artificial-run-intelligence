...
export function DashboardView({
  ...
  const [calMonth, setCalMonth] = useState(data?.rail ? new Date().getMonth() : 7);
  ...
  const streakLabel = rail ? `${rail.streak} day streak` : copy.streak;
