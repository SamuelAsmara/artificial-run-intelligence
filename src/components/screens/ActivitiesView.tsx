...
import { ACT_COPY, buildActivities, fmtPace } from "@/lib/screens/activities";

export function ActivitiesView() {
  const { acts, weekKm, wp } = useMemo(() => buildActivities(), []);
  ...
  const stats = [
    ...
    { v: "47:12", unit: "", name: "10K personal best", divider: "var(--color-line)" },
  ];
